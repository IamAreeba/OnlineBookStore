...
namespace OnlineBookStore.Data.Migrations
{
    ...
    [Migration("20251002195420_added-tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineBookStore.Models.CartDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineBookStore.Models.Stock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineBookStore.Models.CartDetail", b =>
                {
                    ...
                    b.HasOne("OnlineBookStore.Models.ShoppingCart", "ShoppingCart")
            ...
            modelBuilder.Entity("OnlineBookStore.Models.Stock", b =>
                {
                    b.HasOne("OnlineBookStore.Models.Book", "Book")
                        .WithOne("Stock")
                        .HasForeignKey("OnlineBookStore.Models.Stock", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
